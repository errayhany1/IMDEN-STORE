...
const AIChatWidget = () => {
    ...
    const [messages, setMessages] = useState([
        { role: 'assistant', content: 'مرحباً! أنا المساعد الذكي لمتجر Errayhany Store. كيف يمكنني مساعدتك اليوم؟' }
    ]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const systemPrompt = `أنت مساعد مبيعات ذكي ومحترف لمتجر "Errayhany Store" المتخصص في بيع التقنيات والإلكترونيات بالجملة في المغرب.
