            ...
            >
                ...
                <div className="text-center mb-8 mt-2">
                    <div className="inline-block p-3 rounded-2xl bg-primary/10 mb-4">
                        <img src="/logo.png" alt="IMDEN TECHNOLOGY" className="h-12 w-auto object-contain mx-auto mix-blend-multiply dark:mix-blend-normal" onError={(e) => e.target.style.display = 'none'} />
                    </div>
                    <h2 className="text-2xl md:text-3xl font-bold mb-3 text-primary">IMDEN TECHNOLOGY</h2>
                ...
                <div className={`space-y-6 text-base leading-relaxed ${darkMode ? 'text-gray-300' : 'text-slate-600'}`}>
                    <p>
                        تأسست <strong>IMDEN TECHNOLOGY</strong> لتكون الوجهة الأولى والمورد الأقوى لأصحاب المحلات التجارية والموزعين في مجال الإلكترونيات وإكسسوارات الهواتف المحمولة في المغرب.
                    </p>
                    <p>
                    ...
                    <p className="text-center font-medium">
                        في <strong>IMDEN TECHNOLOGY</strong>، التزامنا هو تزويدك بأفضل السلع التقنية لتنمية تجارتك ومضاعفة أرباحك. نحن نعمل بشغف لكي تكون أنت دائماً في الصدارة.
                    </p>
                </div>
